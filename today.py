...
class Stats:
    ...
    def svg_overwrite(self, filename, age_data, commit_data, star_data, repo_data, contrib_data, follower_data, loc_data):
        ...
        self.justify_format(root, 'commit_data', commit_data, 0)
...
def main():
    ...
    star_data = stats.graph_repos_stars('stars', ['OWNER', 'COLLABORATOR', "ORGANIZATION_MEMBER"])
    repo_data =  stats.graph_repos_stars('repos', ['OWNER', 'COLLABORATOR', "ORGANIZATION_MEMBER"])
